...
namespace Demo_File_handling
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string filePath = @"C:\Users\Parth\source\repos\Wipro .NET with react cohort\Week 1 C# Demo\Day 4 Demo Absract class, Interface, exception handling\Demo_File_handling\example.txt";
